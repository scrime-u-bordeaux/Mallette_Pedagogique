...
uint32_t csc;
const byte nb_cs = 8;
byte out[nb_cs] = {29, 27, 25, 11, 8, 10, 24, 26};
byte in[nb_cs] = {30, 28, 26, 12, 9, 11, 25, 27};
int calib[nb_cs];
int i;
uint32_t cs[8];
...
void loop()
{
  ...
  AudioNoInterrupts();
//  biquad1.setLowpass(0, F1, 0.7);
//  biquad2.setLowpass(0, F2, 0.7);
//  biquad3.setLowpass(0, F3, 0.7);
//  biquad4.setLowpass(0, F1, 0.7);
