...
//  bend = analogRead(A0);
//  bend = 0.9 * bend + 0.1 * lastbend;
//  bend = map(bend, 600, 14200, 0, 127);
//  bend = constrain(bend, 0, 127);
//  Serial.println(bend);
//  usbMIDI.sendControlChange(59, bend, 1);

  bend = analogRead(A0);
  usbMIDI.sendPitchBend(bend-16383/2, 1);
